package net.portrix.generic.model.bean;

import com.google.common.base.Objects;
import com.google.common.reflect.TypeToken;
import net.portrix.generic.model.meta.MetaProperty;
...
import net.portrix.generic.model.type.resolved.raw.AbstractRawResolvedAnnotatedElement;
...
public class BeanProperty<X, V> extends AbstractRawResolvedAnnotatedElement implements MetaProperty<X, String, V> {
    ...
    public String toString() {
        return Objects.toStringHelper("dynamic")
                .add("key", getKey())
