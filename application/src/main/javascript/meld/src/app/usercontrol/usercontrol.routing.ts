...
import {UserTableGuard} from './user/table/user-table/user-table.guard';
...
import {RoleCreateGuard, RoleFormGuard} from './role/form/role-form/role-form.guard';
...
import {GroupCreateGuard, GroupFormGuard} from './group/form/group-form/group-form.guard';
...
const appRoutes: Routes = [
  ...
  {path: 'role', component: RoleFormComponent, resolve: {role: RoleCreateGuard}},
  ...
  {path: 'group', component: GroupFormComponent, resolve: {group: GroupCreateGuard}}
];
